...
| P1 | 다양성 필터 강화 — min_diff=max(1,n-2) + archetype 다양성 | 알고리즘 | ✅ 구현 |
| P1 | 점수 분해 / "Why This Comp" — 항목별 점수 시각화 | UX | ✅ 구현 |
| P1 | 단계적 프론트라인 점수 — 이진→등급제 | 알고리즘 | ✅ 구현 |
| P1 | 클립보드 복사 — 로비 채팅용 텍스트 복사 | UX | ✅ 구현 |
| P2 | 적 조합 카운터 점수 — 상성 기반 보너스/패널티 | 알고리즘 | ✅ 구현 |
| P2 | 접이식 조합 카드 — 1위 펼침, 나머지 접힘 | UX | ✅ 구현 |
| P2 | 플렉스 픽 감지 — 2+ 라인 챔피언 표시 | 알고리즘 | ✅ 구현 |
