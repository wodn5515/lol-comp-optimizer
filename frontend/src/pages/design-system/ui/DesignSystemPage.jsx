          ...
          <div className="max-w-md space-y-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      type="text"
                      placeholder="소환사이름#태그"
                      className="w-full rounded-lg border bg-gray-900 pl-8 pr-4 py-2.5 text-sm text-gray-100 placeholder:text-gray-600 border-gray-700 focus:outline-none focus:border-amber-500"
                    />
                  </div>
                </div>
              </div>
            ...
            <SubSection title="Textarea">
              <textarea
                ...
                rows={4}
                className="w-full rounded-lg border border-gray-700 bg-gray-900 px-3 py-2.5 text-sm text-gray-100 placeholder:text-gray-600 focus:outline-none focus:border-amber-500 resize-none"
              />
            </SubSection>

            <SubSection title="Select">
              <select className="rounded-md border bg-gray-900 px-2 py-1.5 text-xs text-gray-300 border-gray-700 focus:outline-none focus:border-amber-500 cursor-pointer">
